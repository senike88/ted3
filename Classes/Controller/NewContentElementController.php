 ...
 * LICENSE.txt file that was distributed with this source code.AAA
 *
...
//        echo "new content"; exit;
       ...
       // \TYPO3\CMS\Extbase\Utility\DebuggerUtility::var_dump( $this->id ); exit;
        ...
        $this->view = $this->getFluidTemplateObject(ucfirst($action));
          ...
          $this->view->setTemplatePathAndFilename('typo3conf/ext/ted3/Resources/Private/Templates/NewContentElement/Wizard.html');

     //   \TYPO3\CMS\Extbase\Utility\DebuggerUtility::var_dump($this->view); exit;   
    ...
    protected function getFluidTemplateObject(string $templateName): StandaloneView
    {
        ...
        $view->setTemplatePathAndFilename(GeneralUtility::getFileAbsFileName('EXT:ted3/Resources/Private/Templates/NewContentElement/' . $templateName . '.html'));
